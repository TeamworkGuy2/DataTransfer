...
public class DataTransferableFactory {
	...
	public static DataTransferInput createReader(DataTransferableFormat type, Reader reader) throws IOException {
		switch(type) {
		case JSON:
	...
	public static DataTransferInput createReader(DataTransferableFormat type, InputStream in)
			throws IOException {
		switch(type) {
		case JSON:
	...
	public static DataTransferInput createReader(DataTransferableFormat type, InputStream in, Charset charset)
			throws IOException {
		switch(type) {
		case JSON:
	...
	public static DataTransferOutput createWriter(DataTransferableFormat type, Writer writer) throws IOException {
		switch(type) {
		case JSON:
	...
	public static DataTransferOutput createWriter(DataTransferableFormat type, OutputStream out)
			throws IOException {
		switch(type) {
		case JSON:
	...
	public static DataTransferOutput createWriter(DataTransferableFormat type, OutputStream out, Charset charset)
			throws IOException {
		switch(type) {
		case JSON:
	...
	public static final void writeBlock(DataTransferOutput out, String blockName, List<? extends DataTransferWritable> elements)
			throws IOException {
		out.writeStartBlock(blockName);
		for(int i = 0, size = elements.size(); i < size; i++) {
