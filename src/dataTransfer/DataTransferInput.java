...
public interface DataTransferInput extends Closeable {
	...
	/** Peek at the next header block of this input stream without reading it.
	...
	/** Read the next opening or closing block tag regardless of its id or name.
	 ...
	 * This also add a corresponding tag to this stream's internal list of open block tags
	...
	/** Get the current read opening data block tag.
	 * This is the block header that is currently being read.
	 * This method will return a new header once {@link #readNextBlock()} or
