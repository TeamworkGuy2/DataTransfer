...
public class ReadWriteTest {
	...
	public static void writeFile(DataTransferFormat format, File file) throws IOException {
		DataTransferOutput out = DataTransferableFactory.createWriter(format, file, true);
		writeDataStream(out);
	}


	public static void readFile(DataTransferFormat format, File file) throws IOException {
